...
namespace DDD\CommandHandlerWithCommandBusWithoutAttachCommandHandler\Post\Infrastructure\Repositories;

use DDD\CommandHandlerWithCommandBusWithoutAttachCommandHandler\Post\Domain\PostRepository;
use DDD\CommandHandlerWithCommandBusWithoutAttachCommandHandler\Post\Domain\PostReviewCouldNotBeStoredException;
