 ...
 *
 * En el ejemplo el tipo de cache es en memoria, es decir, los datos se almacenan en la memoria del servidor.
 * Pero bien podria ser Redis u otro proveedor de cache
 *
